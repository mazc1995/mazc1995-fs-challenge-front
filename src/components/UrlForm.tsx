  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      ...
      >
        ...
        />
        <button
          className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-3 rounded-lg shadow-md transition-all text-lg"
          type="submit"
        >
          Shorten URL
        </button>
